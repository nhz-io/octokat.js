...
/***/ function(module, exports, __webpack_require__) {
	...
	var OctokatBase = function OctokatBase() {
	  ...
	  var newPromise = plugins.filter(function (_ref2) {
	    var promiseCreator = _ref2.promiseCreator;
	  ...
	  _createClass(VerbMethods, [{
	    ...
	    value: function injectVerbMethods(path, obj) {
	      ...
	      if (this._promisePlugin) {
	        ...
	        var newPromise = _promisePlugin$promis.newPromise;
	        var allPromises = _promisePlugin$promis.allPromises;
	      }
	      ...
	      if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' || typeof obj === 'function') {
	        ...
	        console.warn('BUG: Attempted to injectVerbMethods on a ' + (typeof obj === 'undefined' ? 'undefined' : _typeof(obj)));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newPromise = _require.newPromise;
	var allPromises = _require.allPromises;
	...
	module.exports = new (function () {
	  ...
	  _createClass(Authorization, [{
	    ...
	    value: function requestMiddlewareAsync(input, cb) {
	      ...
	      var _input$clientOptions = input.clientOptions;
	      var token = _input$clientOptions.token;
	      var username = _input$clientOptions.username;
	      var password = _input$clientOptions.password;
	  ...
	  _createClass(CacheHandler, [{
	    ...
	    value: function responseMiddlewareAsync(input, cb) {
	      ...
	      if (jqXHR) {
	        ...
	        var path = request.path; // This is also not defined when octo.parse is called
